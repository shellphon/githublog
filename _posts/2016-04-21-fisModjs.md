...
要理解异步加载那部分，需要理解`require.resourceMap`方法与其实际参数具体案例：
...
![image](http://dont27.qiniudn.com/mod1.png)
<a href="http://dont27.qiniudn.com/mod1.png" target="_blank">查看原图</a>

异步部分逻辑看起来有点绕，结合图来看，会清晰一些。

![image](http://dont27.qiniudn.com/mod2.png)
<a href="http://dont27.qiniudn.com/mod2.png" target="_blank">查看原图</a>
